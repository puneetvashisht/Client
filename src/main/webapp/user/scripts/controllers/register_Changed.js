...
*/
		.controller('RegisterCtrl', function($scope, RegistrationService, $http, $location, MsgService) {
...
//                    url : '../dummy/register.json',
									...
									.success(function(data, status, headers,config) {
												...
												if (data.register === true) {$scope.message = data.successMessage;
