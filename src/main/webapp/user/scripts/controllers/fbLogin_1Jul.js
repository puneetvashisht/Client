...
//          console.dir("Error Msg: " +$scope.errMsgService.msg);
        ...
        $scope.me = function() {
            Facebook.api('/me', function(response) {
                ...
                $scope.$apply(function() {
                    ...
                    $scope.getFbRegistration($scope.isFbUser);
        ...
        $scope.getTkLogin = function(){
            $scope.loginService.loginDetails.userName = $scope.user.name;
        ...
        $scope.getTkRegister = function(){
            ...
            if($scope.user.email){
                ...
                alert('Please try with another account, Email id is not available with this account');
                $scope.logout();
                $location.path("/login");
            }
